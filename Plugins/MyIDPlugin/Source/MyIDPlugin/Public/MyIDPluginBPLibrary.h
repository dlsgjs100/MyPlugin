...
public:
	...
	// ===================================================================
	//// DisplayName is the name of the node in the blueprint
	//// Keywords are the words that can be used to search for the node in the blueprint
	//// Category is the category in which the node will be placed in the blueprint
